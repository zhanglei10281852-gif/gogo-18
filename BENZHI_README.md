...
- 项目：zhanglei10281852-gif/gogo-18
- 项目用途：Go coding agent annotation task from localsearch (18)
- Go 工具链：`golang:1.22`
- 前端工具链：无
...
# 启动
cd '/app' && GOTOOLCHAIN=local go run ./cmd/searchcli
...
1. 预期退出码 0：`go test ./internal/query -run "^TestParserParse" -count=1 -v`
